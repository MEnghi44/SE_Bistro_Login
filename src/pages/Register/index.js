  ...
  return (
    <React.Fragment>
      ...
      <div className="container mx-auto z-50 relative">
        <div className="bg-base-100 p-5 mt-10 md:mt-12 max-w-5xl mx-auto rounded-box">
          <div className="text-center">
            <h2 className="mt-4">สมัครสมาชิก</h2>
            <hr className="mt-6"></hr>
          </div>
          <div className="grid md:grid-cols-2 grid-cols-1 gap-5 mt-6">
            <div className="form-control w-8/12 mx-auto">
              <label className="label">
                <span className="label-text far fa-user"> ชื่อจริง</span>
              </label>
              <input
                type="text"
            ...
            <div className="form-control w-8/12 mx-auto">
              <label className="label">
                <span className="label-text far fa-user"> นามสกุล</span>
              </label>
              <input
                type="text"
                placeholder="นามสกุล"
            ...
            <div className="form-control w-8/12 mx-auto">
              <label className="label">
                <span className="label-text fas fa-mobile-alt">
                  {" "}
                  เบอร์โทรศัพท์
                </span>
              </label>
            ...
            <div className="form-control w-8/12 mx-auto grid justify-items-stretch">
              <label className="label">
            ...
            <div className="form-control w-8/12 mx-auto grid justify-items-stretch">
              <label className="label">
                <span className="label-text fas fa-unlock-alt"> ยืนยันรหัสผ่าน</span>
              </label>
              <input
                className="input input-bordered"
                name="pwd1"
              ...
              />
              <div
                className="absolute mt-8 justify-self-end mr-3"
          ...
          <div className="ml-24 md:ml-28 mt-4">
            <input
              type="checkbox"
              id="vehicle1"
              name="vehicle1"
              defaultValue="Bike"
            />
            <label className="text-base" htmlFor="vehicle1">
              {" "}
              ข้อกำหนดการใช้งาน{" "}
            </label>
          </div>
          ...
          <div className="text-center mt-8">
            <h6>
              สำหรับท่านที่เป็นสมาชิกอยู่แล้ว{" "}
              <a href="/Login" className="link link-primary">เข้าสู่ระบบ</a>
            </h6>
          </div>
          ...
          <div className="grid md:grid-cols-4 md:w-full grid-cols-1 mb-10 gap-5 w-2/4 mx-auto ">
            <button className="btn bg-primary-content text-black md:col-start-2 md:col-span-1 hover:bg-primary-focus">
            ...
            <button className="btn bg-primary-content text-info md:col-start-3 md:col-span-1 hover:bg-primary-focus">
              <div className="mr-2 mb-1">
                <svg
                  width="20"
                  height="20"
